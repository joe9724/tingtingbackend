...
func (o *FeedbackDetailOK) WithPayload(payload *models.InlineResponse2005) *FeedbackDetailOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the feedback detail o k response
func (o *FeedbackDetailOK) SetPayload(payload *models.InlineResponse2005) {
	o.Payload = payload
}
