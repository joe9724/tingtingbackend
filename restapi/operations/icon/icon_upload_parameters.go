...
// NewIconUploadParams creates a new IconUploadParams object
// with the default values initialized.
func NewIconUploadParams() IconUploadParams {
	var ()
	return IconUploadParams{}
}

// IconUploadParams contains all the bound params for the icon upload operation
// typically these are obtained from a http.Request
//
// swagger:parameters icon/upload/
...
func (o *IconUploadParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
	...
	fdIconID, fdhkIconID, _ := fds.GetOK("iconId")
	if err := o.bindIconID(fdIconID, fdhkIconID, route.Formats); err != nil {
		res = append(res, err)
	}
...
func (o *IconUploadParams) bindAction(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *IconUploadParams) bindCover(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *IconUploadParams) bindIconID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if err != nil {
		return errors.InvalidType("iconId", "formData", "int64", raw)
	}
	o.IconID = &value
...
func (o *IconUploadParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IconUploadParams) bindTargetID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IconUploadParams) bindType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IconUploadParams) bindUserid(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *IconUploadParams) bindWebURL(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
