...
// NewAlbumEditParams creates a new AlbumEditParams object
// with the default values initialized.
func NewAlbumEditParams() AlbumEditParams {
	var ()
	return AlbumEditParams{}
}

// AlbumEditParams contains all the bound params for the album edit operation
// typically these are obtained from a http.Request
//
// swagger:parameters album/edit/
type AlbumEditParams struct {
...
func (o *AlbumEditParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *AlbumEditParams) bindContent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *AlbumEditParams) bindCover(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *AlbumEditParams) bindIcon(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *AlbumEditParams) bindPriceValue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AlbumEditParams) bindSubTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AlbumEditParams) bindSummary(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AlbumEditParams) bindTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *AlbumEditParams) bindUserid(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
