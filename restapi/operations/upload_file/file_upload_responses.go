...
type FileUploadOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.InlineResponse200191 `json:"body,omitempty"`
}
...
func (o *FileUploadOK) WithPayload(payload *models.InlineResponse200191) *FileUploadOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the file upload o k response
func (o *FileUploadOK) SetPayload(payload *models.InlineResponse200191) {
	o.Payload = payload
}
