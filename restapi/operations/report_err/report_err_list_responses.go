...
func (o *ReportErrListOK) WithPayload(payload *models.InlineResponse2006) *ReportErrListOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the report err list o k response
func (o *ReportErrListOK) SetPayload(payload *models.InlineResponse2006) {
	o.Payload = payload
}
