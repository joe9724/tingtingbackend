...
func NewBookDeleteParams() BookDeleteParams {
	var ()
	return BookDeleteParams{}
}

// BookDeleteParams contains all the bound params for the book delete operation
// typically these are obtained from a http.Request
//
// swagger:parameters book/delete
...
func (o *BookDeleteParams) bindBookID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *BookDeleteParams) bindUserid(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
