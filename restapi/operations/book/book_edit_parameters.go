...
// NewBookEditParams creates a new BookEditParams object
// with the default values initialized.
func NewBookEditParams() BookEditParams {
	var ()
	return BookEditParams{}
}

// BookEditParams contains all the bound params for the book edit operation
// typically these are obtained from a http.Request
//
// swagger:parameters book/edit/
type BookEditParams struct {
...
func (o *BookEditParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *BookEditParams) bindContent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *BookEditParams) bindCover(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *BookEditParams) bindIcon(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *BookEditParams) bindSubTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *BookEditParams) bindSummary(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *BookEditParams) bindTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *BookEditParams) bindUserid(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
