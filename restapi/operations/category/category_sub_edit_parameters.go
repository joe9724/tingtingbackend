...
// NewCategorySubEditParams creates a new CategorySubEditParams object
// with the default values initialized.
func NewCategorySubEditParams() CategorySubEditParams {
	var ()
	return CategorySubEditParams{}
}

// CategorySubEditParams contains all the bound params for the category sub edit operation
// typically these are obtained from a http.Request
//
// swagger:parameters category/sub/edit/
type CategorySubEditParams struct {
...
func (o *CategorySubEditParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *CategorySubEditParams) bindContent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CategorySubEditParams) bindCover(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *CategorySubEditParams) bindIcon(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *CategorySubEditParams) bindSubTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CategorySubEditParams) bindSummary(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CategorySubEditParams) bindTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CategorySubEditParams) bindUserid(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
