...
func (o *CategoryDeleteOK) WithPayload(payload *models.InlineResponse20017) *CategoryDeleteOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the category delete o k response
func (o *CategoryDeleteOK) SetPayload(payload *models.InlineResponse20017) {
	o.Payload = payload
}
