...
func (o *CategorySubEditOK) WithPayload(payload *models.InlineResponse20015) *CategorySubEditOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the category sub edit o k response
func (o *CategorySubEditOK) SetPayload(payload *models.InlineResponse20015) {
	o.Payload = payload
}
