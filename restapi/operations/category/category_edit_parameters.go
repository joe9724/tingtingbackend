...
// NewCategoryEditParams creates a new CategoryEditParams object
// with the default values initialized.
func NewCategoryEditParams() CategoryEditParams {
	var ()
	return CategoryEditParams{}
}

// CategoryEditParams contains all the bound params for the category edit operation
// typically these are obtained from a http.Request
//
// swagger:parameters category/edit/
...
func (o *CategoryEditParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *CategoryEditParams) bindContent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CategoryEditParams) bindCover(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *CategoryEditParams) bindIcon(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *CategoryEditParams) bindSubTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CategoryEditParams) bindSummary(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CategoryEditParams) bindTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CategoryEditParams) bindUserid(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
