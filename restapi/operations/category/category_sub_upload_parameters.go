...
// NewCategorySubUploadParams creates a new CategorySubUploadParams object
// with the default values initialized.
func NewCategorySubUploadParams() CategorySubUploadParams {
	var ()
	return CategorySubUploadParams{}
}

// CategorySubUploadParams contains all the bound params for the category sub upload operation
// typically these are obtained from a http.Request
//
// swagger:parameters category/sub/upload/
type CategorySubUploadParams struct {
...
func (o *CategorySubUploadParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *CategorySubUploadParams) bindContent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CategorySubUploadParams) bindCover(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *CategorySubUploadParams) bindIcon(file multipart.File, header *multipart.FileHeader) error {

	return nil
}

func (o *CategorySubUploadParams) bindSubTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CategorySubUploadParams) bindSummary(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CategorySubUploadParams) bindTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CategorySubUploadParams) bindUserid(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
