...
func (o *CategoryEditOK) WithPayload(payload *models.InlineResponse20016) *CategoryEditOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the category edit o k response
func (o *CategoryEditOK) SetPayload(payload *models.InlineResponse20016) {
	o.Payload = payload
}
