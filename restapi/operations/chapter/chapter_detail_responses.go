...
func (o *ChapterDetailOK) WithPayload(payload *models.InlineResponse20023) *ChapterDetailOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the chapter detail o k response
func (o *ChapterDetailOK) SetPayload(payload *models.InlineResponse20023) {
	o.Payload = payload
}
