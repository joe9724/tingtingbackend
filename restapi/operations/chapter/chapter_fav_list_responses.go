...
func (o *ChapterFavListOK) WithPayload(payload *models.InlineResponse20022) *ChapterFavListOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the chapter fav list o k response
func (o *ChapterFavListOK) SetPayload(payload *models.InlineResponse20022) {
	o.Payload = payload
}
