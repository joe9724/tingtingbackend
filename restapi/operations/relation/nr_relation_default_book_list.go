...
func (o *NrRelationDefaultBookList) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	for rows.Next() {
		...
		err = rows.Scan(&id,&name,&grade,&startTime,&endTime,&bookId,&status)
		if err != nil{
			fmt.Println(err.Error())
		}
