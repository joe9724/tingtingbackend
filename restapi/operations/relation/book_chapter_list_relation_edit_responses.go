...
func (o *BookChapterListRelationEditOK) WithPayload(payload *models.InlineResponse20017) *BookChapterListRelationEditOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the book chapter list relation edit o k response
func (o *BookChapterListRelationEditOK) SetPayload(payload *models.InlineResponse20017) {
	o.Payload = payload
}
