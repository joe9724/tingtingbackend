...
// NewBannerListParams creates a new BannerListParams object
// with the default values initialized.
func NewBannerListParams() BannerListParams {
	var ()
	return BannerListParams{}
}

// BannerListParams contains all the bound params for the banner list operation
// typically these are obtained from a http.Request
//
// swagger:parameters banner/list
type BannerListParams struct {
...
func (o *BannerListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *BannerListParams) bindPageIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *BannerListParams) bindPageSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *BannerListParams) bindUserid(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
